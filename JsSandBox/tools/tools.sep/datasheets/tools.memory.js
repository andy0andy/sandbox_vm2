...
if (sandbox_vm2.sep === "datasheets") {

    sandbox_vm2.memory = {
        "dom": {
            "Document_getElementsByTagName": {}, // Document.getElementsByTagName
            "Performance_eventCounts": {} // Performance.eventCounts
        },
        "bom": {     // 初始化信息
            navigator: {
                appCodeName: "Mozilla",
            ...
            location: {
                search: "?q=98DX243-A2-BCW1C000",
                hash: "",
                host: "www.datasheets.com",
                hostname: "www.datasheets.com",
                href: "https://www.datasheets.com/en/search?q=98DX243-A2-BCW1C000",
